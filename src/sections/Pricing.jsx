    ...
    <section>
      <Element name="pricing">
        <div className="container">
          ...
          border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none
          max-md:pb-32 max-md:pt-16"
          >
            <h3
              className="h3 max-lg:h3 max-md:h5 z-3 relative mx-auto mb-14 
            max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm"
            >
              Flexible pricing for teams for teams of all sizes
            </h3>
            {/* 月/年 button */}
            <div
              className="relative z-4 mx-auto flex w-[375px] rounded-3xl
            border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[8px] max-md:w-[310px]"
            >
              <button
            ...
            <div className="pricing-bg">
              ...
              <img
                ...
                height={380}
                alt="outline"
                className="absolute inset-0 opacity-5 z-2 mix-blend-soft-light"
              />
            </div>
          </div>
          {/* 价格部分 */}
          ...
          >
            {plans.map((plan, index) => (
              <div
                key={plan.id}
                className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7
              ...
              >
                ...
                <div
                  className={clsx(
                    "absolute left-0 right-0 z-2 flex items-start-center justify-center",
